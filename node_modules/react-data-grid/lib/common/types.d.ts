...
export declare type CellContentRenderer<TRow> = (props: CellContentRendererProps<TRow>) => React.ReactNode;
export declare type CellContentRendererProps<TRow> = Pick<CellRendererProps<TRow>, 'idx' | 'rowIdx' | 'rowData' | 'column' | 'cellMetaData' | 'expandableOptions' | 'isRowSelected' | 'onRowSelectionChange' | 'isSummaryRow'>;
